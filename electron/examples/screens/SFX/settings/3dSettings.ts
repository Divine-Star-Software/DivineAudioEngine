...
const dirDisplay: any = { pre: null };

export const _3dsfxSettings = (cascadeProps: any): ElementTreeData => {
  return [
    {
      type: "form",
      attrs: {
        ...
        Div("form-button", [
          {
            ...
            events: {
              onClick: () => {
                const forward: BABYLON.Vector3 =
                  ScneeObjects.camera.getDirection(
